...
const AttendanceHistory = ({ onLogout }) => {
  ...
  const [shiftInfo, setShiftInfo] = useState(null); // Shift Data
                    ...
                    <tbody>
                      {displayed.map((r, idx) => (
                        <tr key={r.id} style={{ textAlign: "center", verticalAlign: "middle" }}>
                          ...
                          {/* Time Column with Dynamic Color */}
